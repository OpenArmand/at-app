  ...
  this.socket.on('gottenInfluencerCampaign', async(data)=>{
    ...
    _approve= async () => {
      ...
      Alert.alert(
         ...
         if(this.state.influencerEvent.dateOptions==''){
        ...
        this.socket.emit('editInfluencerCampaign', {key:await SecureStore.getItemAsync('influencerCampaignSelectedKey'),clientUsername:await SecureStore.getItemAsync('clientSelectedUsername'),influencerCampaign:campaign,index:index,justPicked:justPicked,event:event});
        ...
        return(
          ...
          <Text> Once the influencer posts, their posts will show up here </Text>
            ...
            return(
              ...
              <View>
              <Button title="Approve" onPress={()=> this._approve()} />
              </View>
